(function() {
  var Permalink, async, colors, command, createPermalink, expandPattern, fileUtil, fs, glob, hexo, log, moment, oldPermalink, pathUtil, permalink, processFile, ref, removeExt, util, yfm;
  ...
  ref = require('./utils'), log = ref.log, removeExt = ref.removeExt;
